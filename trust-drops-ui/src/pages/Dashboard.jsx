...
function Dashboard({ value }) {
  ...
  // console.log("dashboard mode", value);
  ...
  async function loadUserData() {
    ...
    (stakesData || []).concat(receivedData || []).map((el) => {
      if (!finalStakesData[el.address])
        finalStakesData[el.address] = { address: el.address };

      if (el.credibility) {
        finalStakesData[el.address].stake = el.stake;
        finalStakesData[el.address].credibility = ethers.utils.formatUnits(
          el.credibility,
          2
        );
      }
      if (el.credibilityGained) {
        ...
        finalStakesData[el.address].credibilityGained =
          ethers.utils.formatUnits(el.credibilityGained, 2);
      }
    });
  ...
  return (
    ...
    >
      <div className="  w-full  font-mono bg-white  dark:bg-black   dark:text-white pb-5">
        <div className="flex flex-col items-center  ">
          <div className="dashboard-container  w-[90%]  mt-4 ">
            <div className="top-container flex flex-col ">
              <div className="heading-container font-bold text-[#7071E8] text-[32px]">
                Credibilty staking
              </div>
          ...
          <div className="main-container  flex flex-col md:flex-row justify-between gap-4 mt-4 w-[90%]">
            <div className="credibility-staking-container  dark:bg-[rgba(112,113,232,0.03)] border-2  border-[#7071E8] p-4 md:p-5 shadow-md md:w-[40%] mb-4 md:mb-0 ">
              ...
              <div className="flex flex-col gap-2 mb-4">
                {isStaking ? (
                  <>
                    <label
                      htmlFor="address"
                      className="font-semibold text-[#7071E8]"
                    >
                      Stake for address
                    </label>
                    <input
                      ...
                      className="p-2 rounded outline-none border-2 border-[#7071E8] dark:bg-white text-black"
                    />
                    <label
                      htmlFor="quantity"
                      className="font-semibold text-[#7071E8]"
              ...
              >
                <div className="top-data-container flex flex-col gap-2">
                  <span className="dark:text-white text-black">
                    ...
                    and use the #stake-for-stake channel to request our
                    community members to stake on you.
                  </span>
                  <div className="top-container dark:bg-black bg-white w-full flex max-md:flex-col justify-around py-4 ">
                    ...
                    <div className="data-container flex flex-col flex-1 items-center  justify-center max-md:pb-5 md:border-l-[1px] md:border-[#7071E8]">
                      ...
                      <div className="data-value-container text-[24px] flex gap-[4px]">
                        ...
                        <div className="dark:text-white">
                          {mandBalance?.value
                            ? truncateAmount(mandBalance.value)
                            : 0}
                        </div>
                      </div>
                    </div>{" "}
                      ...
                      <div className="data-value-container text-[24px] flex gap-[4px]">
                        ...
                        <div className="dark:text-white">
                          {stakedBalance?.result
                            ? truncateAmount(stakedBalance.result)
                            : 0}
                        </div>
                      </div>
                    </div>{" "}
                  ...
                  <div className="bottom-container flex max-md:flex-col justify-around">
                    <div className="data-container flex flex-col gap-2 items-center  justify-center dark:bg-black bg-white w-[30%] max-md:w-[100%]">
                      <div
                      ...
                      <div className="info-container  bg-[#7071E8] dark:text-black text-white flex items-center gap-2 w-full px-2">
                    ...
                    <div className="data-container flex flex-col  items-center  justify-between  dark:bg-black bg-white w-[30%] max-md:mt-2 max-md:w-[100%]">
                ...
                <div
                  className={`credibiliy-rewards-container  mb-4 bg-white  h-[60%]  text-black placeholder:p-2 p-2 dark:bg-black dark:text-white`}
                >
